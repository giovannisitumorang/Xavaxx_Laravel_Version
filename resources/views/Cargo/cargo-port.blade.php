                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <button class="btn btn-link" onclick="edtItem('4dd1aecc-fa04-4c1b-98fd-530245b4007f');"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-link" onclick="delItem('4dd1aecc-fa04-4c1b-98fd-530245b4007f');"><i class="fa fa-trash-o"></i></button>
                                </div>
                              </div>
                            </td>
                          </tr>
                          <tr class="text-center">
                            <td>Tanjung Periok</td>
                            <td>INDONESIA</td>
                            <td>
                              <div class="dropdown">
                                <button type="button" class="btn btn-icons btn-rounded text-center" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <button class="btn btn-link" onclick="edtItem('12a7e7cb-aebd-4986-a30a-474894712b19');"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-link" onclick="delItem('12a7e7cb-aebd-4986-a30a-474894712b19');"><i class="fa fa-trash-o"></i></button>
                                </div>
                              </div>
                            </td>
                          </tr>
