                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <button class="btn btn-link" onclick="edtItem('99c9821e-3881-45ac-8fc6-498e88f1fb15');"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-link" onclick="delItem('99c9821e-3881-45ac-8fc6-498e88f1fb15');"><i class="fa fa-trash-o"></i></button>
                                </div>
                              </div>
                            </td>
                          </tr>
