...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax_auth_object = {"ajaxurl":"https:\/\/www.urbanui.com\/wp-admin\/admin-ajax.php","redirecturl":"\/chroma\/documentation\/path-to\/node_modules\/bootstrap-datepicker\/dist\/css\/bootstrap-datepicker.min.css","loadingmessage":"Please wait..."};
/* ]]> */
</script>
...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
  ...
  display: none;
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="f4d2646521" /><input type="hidden" name="_wp_http_referer" value="/chroma/documentation/path-to/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="4ab31cd4f9" /><input type="hidden" name="_wp_http_referer" value="/chroma/documentation/path-to/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="9bac28b6c5" /><input type="hidden" name="_wp_http_referer" value="/chroma/documentation/path-to/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />  
